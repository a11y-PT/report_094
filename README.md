---
website: "Serviços de Ação Social do Instituto Politécnico do Cávado e Ave"          # Entre as aspas escreve o nome do website
date: "13/07/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://portal.sas.ipca.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://portal.sas.ipca.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Serviços de Ação Social do IP do Cávado e Ave"         # Entre as aspas escrever o nome do owner do website
